(function (root) {
  ...
  const TOOL_CATEGORIES = Object.freeze([
    ...
    toolCategory('science-conversions', 'Science conversions', 'Engineering and laboratory units', ICONS.scienceConversions, [
      toolSubcategory('mechanics-energy', 'Mechanics & energy', pickTools(scienceConversionCatalog, ['unit-pressure', 'unit-energy', 'unit-power', 'unit-force', 'unit-angle', 'unit-frequency', 'unit-acceleration', 'unit-torque'])),
      toolSubcategory('fluids-materials', 'Fluids & materials', pickTools(scienceConversionCatalog, ['unit-density', 'unit-flow', 'unit-dynamic-viscosity', 'unit-kinematic-viscosity'])),
      toolSubcategory('electricity-units', 'Electricity', pickTools(scienceConversionCatalog, ['unit-charge', 'unit-current', 'unit-voltage', 'unit-resistance', 'unit-capacitance'])),
      toolSubcategory('light-radiation-magnetism', 'Light, radiation & magnetism', pickTools(scienceConversionCatalog, ['unit-illuminance', 'unit-radioactivity', 'unit-radiation-dose', 'unit-magnetic-flux', 'unit-magnetic-field'])),
