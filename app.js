(function (root) {
  ...
  function openInfo(type) {
    ...
    if (type === 'changelog') dom.infoContent.insertAdjacentHTML('afterbegin', `<h3>1.0.8</h3><ul class="capability-list"><li>Top-anchored folder controls with themed create, rename, and delete dialogs</li><li>Save Calculation main keypad action</li><li>Triangle values kept outside the diagram and reference square</li><li>Matched half-ellipse cylinder and cone base curves</li><li>Quadratic apex X and Y result coordinates</li></ul>`);
