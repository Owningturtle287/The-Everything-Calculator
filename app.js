(function (root) {
  ...
  const TOOL_CATEGORIES = Object.freeze([
    toolCategory('conversions', 'Everyday conversions', 'Common measurements, time & motion', ICONS.conversions, [
      toolSubcategory('measurements', 'Measurements', pickTools(everydayUnits, ['unit-length', 'unit-area', 'unit-volume', 'unit-mass', 'unit-temperature'])),
      toolSubcategory('time-motion', 'Time & motion', pickTools(everydayUnits, ['unit-time', 'unit-speed', 'unit-fuel-economy'])),
    ]),
    toolCategory('science-conversions', 'Science conversions', 'Engineering and laboratory units', ICONS.scienceConversions, [
      toolSubcategory('mechanics-energy', 'Mechanics & energy', pickTools(scienceUnits, ['unit-pressure', 'unit-energy', 'unit-power', 'unit-force', 'unit-angle', 'unit-frequency', 'unit-acceleration', 'unit-torque'])),
      toolSubcategory('fluids-materials', 'Fluids & materials', pickTools(scienceUnits, ['unit-density', 'unit-flow', 'unit-dynamic-viscosity', 'unit-kinematic-viscosity'])),
      toolSubcategory('electricity-units', 'Electricity', pickTools(scienceUnits, ['unit-charge', 'unit-current', 'unit-voltage', 'unit-resistance', 'unit-capacitance'])),
      toolSubcategory('light-radiation-magnetism', 'Light, radiation & magnetism', pickTools(scienceUnits, ['unit-illuminance', 'unit-radioactivity', 'unit-radiation-dose', 'unit-magnetic-flux', 'unit-magnetic-field'])),
    ]),
    toolCategory('finance', 'Economics', 'Loans, savings, pricing & business', ICONS.finance, [
      toolSubcategory('loans-housing', 'Loans & housing', pickTools(FINANCE_TOOLS, ['calc-loan-payment', 'calc-mortgage-payment'])),
      toolSubcategory('interest-savings', 'Interest & savings', pickTools(FINANCE_TOOLS, ['calc-compound-interest', 'calc-simple-interest', 'calc-savings-goal'])),
      toolSubcategory('prices-exchange', 'Prices & exchange', pickTools(FINANCE_TOOLS, ['calc-currency', 'calc-discount', 'calc-sales-tax', 'calc-tip-split'])),
      toolSubcategory('business', 'Business', pickTools(FINANCE_TOOLS, ['calc-profit-margin', 'calc-break-even'])),
    ]),
    toolCategory('health', 'Health & fitness', 'General wellness estimates', ICONS.health, [
      toolSubcategory('body-metrics', 'Body metrics', pickTools(HEALTH_TOOLS, ['calc-bmi', 'calc-bmr', 'calc-tdee', 'calc-body-surface-area'])),
      toolSubcategory('training', 'Training', pickTools(HEALTH_TOOLS, ['calc-pace', 'calc-target-heart-rate'])),
    ]),
    ...
    toolCategory('everyday', 'Everyday life', 'Trips, dates, work and projects', ICONS.everyday, [
      ...
      toolSubcategory('work-dates', 'Work & dates', pickTools(EVERYDAY_TOOLS, ['calc-work-time', 'calc-date-difference'])),
    ]),
