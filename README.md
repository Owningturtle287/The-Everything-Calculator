...
A responsive, dependency-free HTML build of The Everything Calculator 1.0.4. It includes a live scientific expression engine, native MathML formula layout, 34 conversion families, 58 practical calculators, light/dark/system themes, unlimited favorites, local history, bundled icons, live reference-rate currency conversion, visual graphs/shapes, and offline PWA support for the local app shell.

## Version 1.0.4 highlights

- Larger logo with a quieter version badge and corrected divide/backspace placement
- Denser toolbox lists and narrower date-difference controls
- Automatic triangle solving and classification from only the measurements entered
- True-proportion green geometry visuals with a user-adjustable, equally scaled red reference
- Lighter visual labels and a zoomable quadratic graph with 0.2 subdivisions and a marked apex
- Rocket branding for Science & engineering and corrected geometry equation badges
- Direct Frankfurter v2 currency rates with v1 and locally cached fallbacks
