...
assert.equal(calculator.VERSION, '1.0.5');
...
assert.match(index, /<small class="version-label">v1\.0\.5<\/small>/);
...
assert.match(styles, /\.tool-drawer\s*\{[^}]*width:\s*min\(270px,/s);
...
assert.match(worker, /everything-calculator-v1\.0\.5/);
