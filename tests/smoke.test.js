...
assert.equal(calculator.VERSION, '1.0.7');
...
assert.match(index, /<small class="version-label">v1\.0\.7<\/small>/);
...
assert.match(worker, /everything-calculator-v1\.0\.7/);
...
assert.match(appSource, /Leg 1 \(a\) ·/);
